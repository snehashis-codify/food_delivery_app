  ...
  const restData = [
    {
      info: {
        ...
        availability: {
          nextCloseTime: "2024-04-21 04:00:00",
          opened: true,
        },
        badges: {
          imageBadges: [
      ...
      analytics: {
        context: "seo-data-2371d500-2766-4038-a349-d96a11de6911",
      },
      cta: {
    ...
    },
    {
      info: {
        ...
        availability: {
          nextCloseTime: "2024-04-21 03:30:00",
          opened: true,
        },
        badges: {},
        isOpen: true,
    ...
    },
    {
      info: {
        id: "364644",
        name: "Babai Food Centre",
        cloudinaryImageId: "ytoleth59xpz83djv8df",
        ...
        availability: {
          nextCloseTime: "2024-04-21 06:15:00",
          opened: true,
        },
        badges: {},
        isOpen: true,
      ...
      cta: {
        link: "https://www.swiggy.com/restaurants/babai-food-centre-bapuji-nagar-jadavpur-kolkata-364644",
        text: "RESTAURANT_MENU",
        type: "WEBLINK",
      },
      widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
    },
    {
      info: {
        ...
        cloudinaryImageId: "c1dzqmkw8tkyzvnnumxs",
        ...
        availability: {
          nextCloseTime: "2024-04-21 04:20:00",
          opened: true,
        },
        badges: {},
        isOpen: true,
      ...
      cta: {
        link: "https://www.swiggy.com/restaurants/elahi-luxury-dining-park-circus-kolkata-332417",
        text: "RESTAURANT_MENU",
        type: "WEBLINK",
      },
      widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
    },
    {
      info: {
        ...
        costForTwo: "₹350 for two",
        cuisines: ["Chinese", "Thai", "Seafood", "Asian"],
        avgRating: 4.3,
        parentId: "226364",
        avgRatingString: "4.3",
        totalRatingsString: "10K+",
  ...
  return (
    <div className="p-3">
      ...
      <div className="flex flex-wrap">
        {restData?.map((data) => {
          return <RestaurantCard key={data.info.id} restData={data} />;
        })}
      </div>
    </div>
  );
